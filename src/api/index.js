...
export const postLinkOrder = (data) => {
  return request.post("/order/link", data);
};
export const postCrossOrder = (data) => {
  return request.post("/order/cross", data);
};
// 导入
...
export function postSegment(formData) {
  return request.post("/segment", formData, {
    headers: {
      "Content-Type": "multipart/form-data",
    },
  });
